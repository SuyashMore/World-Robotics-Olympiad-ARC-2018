...
bool K_processPID(botData& newSensor,botData& oldSensor,Motor& motor,float outH,float outLow,float Kd)
{
  ...
  // cout<<"Front Error:"<<fronterror<<",Previous Front Error:"<<fronterrorprevious<<endl;
    ...
    motor.PWM[MOTOR_FRONT] = Vmap(frontpwm, F_MOTOR_MAP_INLOW, F_MOTOR_MAP_INHIGH, outLow, outH);
    motor.PWM[MOTOR_BACK] = Vmap(backpwm, B_MOTOR_MAP_INLOW, B_MOTOR_MAP_INHIGH, outLow, outH);
